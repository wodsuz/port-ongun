...
import { FaFileCode, FaDownload, FaHackerrank,FaGithub, FaLinkedin, FaLocationArrow } from 'react-icons/fa';
...
const Sidebar = () => {
    return (
        ...
        <h3 className='my-4 text-3xl font-medium font-kaushan'> <span> Ongun Demirağ  </span> </h3>

        <p className='flex items-center justify-center px-2 py-1 my-3 bg-gray-300 rounded-full'> 
            <FaFileCode  className='w-7 h-7 '/> <p className='px-3'>  Web & Front-end Developer </p>
        </p>
        <a className='flex items-center justify-center px-2 py-1 my-3 bg-gray-300 rounded-full' 
            href=''
            download='name' >
            <GiDiploma  className='w-8 h-8' /> <p className='px-3'> Certificates & Skills </p>
        </a>
        <a className='flex items-center justify-center px-2 py-1 my-3 bg-gray-300 rounded-full' 
            href=''
            download='name' >
            <FaDownload  className='w-7 h-7 ' />  <p className='px-3'> Download Resume </p> 
        </a>
